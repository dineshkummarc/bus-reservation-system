        ...
        <div class="card-body">
            ...
            <form action="<?php echo base_url(route_to('create-vehicle')) ?>" id="vehical" method="post" class="row g-3" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="col-3">
                    ...
                    <input type="text" placeholder="Reg No" name="reg_no" value="<?php echo esc(old('reg_no'))  ?>" class="form-control" required />
                </div>
                ...
                <div class="col-3">
                    ...
                    <input type="text" name="engine_no" id="engine_no" placeholder="Eng No" value="<?php echo esc(old('engine_no')) ?>" class="form-control" required />
                </div>
                ...
                <div class="col-3">
                    ...
                    <input type="text" name="model_no" id="model_no" placeholder="Model No" value="<?php echo esc(old('model_no'))  ?>" class="form-control" required />
                </div>
                ...
                <div class="col-3">
                    ...
                    <input type="text" name="chasis_no" id="chasis_no" placeholder="Chasis No" value="<?php echo esc(old('chasis_no'))  ?>" class="form-control" required />
                </div>
                ...
                <div class="col-3">
                    ...
                    <input type="text" name="company" id="company" value="<?php echo esc(old('company'))  ?>" placeholder="Company" class="form-control" required />
                </div>
