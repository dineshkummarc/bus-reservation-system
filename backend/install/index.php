<?php 
    ...
    $path = [
        ...
        'config_path'   => '../app/Config/App.php',
        //new code for env 
        'env_template_path' => 'php/.env',
        'env_output_path'   => '../.env',
    ];

    $path1 = [
        'template_path'    => 'php/Cryptobox.config.php',
        'output_path'      => '../app/Modules/Gourl/Libraries/gourl/lib/cryptobox.config.php',
    ];

    $message      = null; 
    $activeClass  = null; 

    //Get if purchase key used or not
    ...
    // Insert Login Information
        ...
        // End of login info insert
            ...
            // -----------------------------------------NO need for This Project ----------------------------
                     ...
                     if ($FileWrite->envconfig($path,$_POST) === false) {
                                //write env file
                                $message .= "<li>The env file could not be written, ";
                                $message .= "please chmod gourl/lib/cryptobox.config.php file to 777</li>";
                    }
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php if($_SESSION['purchase_key_used']){ ?>
                                                ...
                                                <!-- <a target="_blank" class="btn btn-warning pull-right" href="https://www.bdtask.com/license-update.php?<?php echo 'product_key='.$Verification->get_product_key().'&'.'purchase_key='.base64_encode($_GET['purchase_key']);?>" role="button">Update Purchase Key</a> -->
                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="userid" name="userid" value="<?php echo @$_GET['userid'] ?>" placeholder="Enter random value" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="password" class="form-control" id="purchase_key" value="<?php echo @$_GET['purchase_key'] ?>"  name="purchase_key"  placeholder="Enter random value" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
