                    ...
                    <?php foreach ($alltriplist as $kye => $tripValue) : ?>
                        ...
                        <div class="card-body Regular shadow mt-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <?php $print = 0; ?>
                                    <a target="_blank" href="<?php echo base_url(route_to('getJourneylistData-ticket', $tripValue->trip_id, $filterjourneydate, $print)) ?>" class="btn btn-success" id="<?php echo $tripValue->id; ?>" type="button">Journey List</a>
                                </div>
